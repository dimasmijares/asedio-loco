...
export const AMMO: Record<AmmoId, AmmoDef> = {
  ...
  coconuts: { id: 'coconuts', name: 'Racimo de cocos', rarity: 'comun', icon: '🥥', color: '#6b4226', desc: 'Se divide en 4 cocos en el punto más alto.', weight: 14, shape: 'ball', radius: 0.42, density: 4, restitution: 0.3, friction: 0.6, drag: 0.004, windFactor: 0.3 },
  ...
  chicken: { id: 'chicken', name: 'Gallina saltarina', rarity: 'rara', icon: '🐔', color: '#fff3b0', desc: 'Rebota 3 veces con mucha mala leche.', weight: 7, shape: 'ball', radius: 0.34, density: 6, restitution: 0.75, friction: 0.4, drag: 0.005, windFactor: 0.5 },
  ...
  snowball: { id: 'snowball', name: 'Bola de nieve', rarity: 'epica', icon: '❄️', color: '#e0fbfc', desc: 'Crece mientras rueda. Y crece. Y crece.', weight: 3, shape: 'ball', radius: 0.45, density: 0.9, restitution: 0.05, friction: 1, drag: 0.004, windFactor: 0.3 },
