...
export const AMMO: Record<AmmoId, AmmoDef> = {
  ...
  piano: { id: 'piano', name: 'Piano', rarity: 'rara', icon: '🎹', color: '#222222', desc: 'Cae en vertical sobre el punto marcado.', weight: 6, shape: 'box', radius: 0.5, length: 1.7, density: 6, restitution: 0.05, friction: 0.7, drag: 0.003, windFactor: 0.2 },
